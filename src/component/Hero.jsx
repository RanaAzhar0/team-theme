...
const Hero = () => {
  return (
    <>
    <section className='bg-black  top-0'>
	<div class="bg-black text-white h-[90vh]">
		<div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
			...
			<div class="p-8 mt-12 mb-6 md:mb-0 md:mt-0 ml-0 md:ml-12 lg:w-2/3  justify-center">
				<div class="h-48 flex flex-wrap content-center">
					<div>
						<img class=" mt-28 hidden xl:block" src="https://user-images.githubusercontent.com/54521023/116969935-c13d5b00-acd4-11eb-82b1-5ad2ff10fb76.png"/></div>
						<div>
							...
							<div>
								<img class=" mt-28 hidden lg:block" src="https://user-images.githubusercontent.com/54521023/116969939-c1d5f180-acd4-11eb-8ad4-9ab9143bdb50.png"/></div>
							</div>
						</div>
					</div>
				</div>
